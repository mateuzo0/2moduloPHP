	...
	<div class="container-fluid">
	  <div class="row">	  	
	  	<div class="col-8 offset-2">
	  		<form action="produtosreceber.php" method="POST">
				<div class="card">
				  ...
				  <div class="card-body">
				    <div class="row">
		  				...
		  				<div class="col-md-4">
		  					<label> Codido de estoque: <span class="text-danger">*</span></label><br>
							<input type="text" name="estoque" class="form-control" required><br>
		  				</div>

		  				<div class="col-md-6">
		  					<label> Preço: <span class="text-danger">*</span> </label><br>
							<input type="number" name="preco" class="form-control" required><br>
		  				</div>
